...
public class ManageDriver extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "Name", "User Name", "Password", "Status", "Standby"
            }
        ));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        Integer id = (Integer)jTable1.getValueAt(jTable1.getSelectedRow(), 0);
        if(("1").equals(userDao.selectById(id).getStatus_by())){
            JOptionPane.showMessageDialog(null, "The driver is in working, cannot be deleted");
        }else{
