...
public class Configuration {
    ...
    public static void configureFlight(ArrayList<Airplane> airplaneList){
        try {
            ...
            Date d1 = format.parse("2020-10-01");
            Date d2 = format.parse("2020-10-10");
            Date d3 = format.parse("2020-10-03");
            Date d4 = format.parse("2020-10-30");
            ...
            Flight f1 = new Flight(airliner1,"AA1111",airplane1,"BOS","SHA",d1,st1,at1,500);
            Flight f2 = new Flight(airliner1,"BB1111",airplane2,"NY","LON",d2,st2,at2,354);
            Flight f3 = new Flight(airliner2,"CC1111",airplane3,"BOS","SHA",d3,st3,at3,800);
            Flight f4 = new Flight(airliner2,"DD1111",airplane4,"NY","LON",d4,st4,at4,352);
    ...
    public static void configureCustomer(TravelOffice travelOffice){
        ...
        customer1.setName("JIAN");
        customer1.setIdentityType("Passport");
        customer1.setIdentityID("E11111");
        
        
        Customer customer2 = new Customer(travelOffice);
        customer2.setName("SUN");
        customer2.setIdentityType("DriverLicense");
        customer2.setIdentityID("E22222");
        
        Customer customer3 = new Customer(travelOffice);
        customer3.setName("ZHU");
        customer3.setIdentityType("Passport");
        customer3.setIdentityID("E33333");
        ...
        travelOffice.getCustomerDirectory().getCustomerList().add(customer3);
    }
